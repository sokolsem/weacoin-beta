...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " weacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  weacoin-tx [options] <hex-tx> [commands]  Update hex-encoded weacoin transaction\n" +
            "or:     weacoin-tx [options] -create [commands]   Create hex-encoded weacoin transaction\n" +
            "\n";
