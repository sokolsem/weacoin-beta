Contributing to Weacoin Core
============================

The Weacoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the weacoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/weacoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to weacoin-qt
...
The following applies to code changes to the weacoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall weacoin
Network Protocol consensus changes.

Whether a pull request is merged into weacoin Core rests with the project merge
...
Patches that change weacoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the weacoin consensus, it must have been
...
The project leader is the release manager for each weacoin Core release.
